...
import com.emamagic.login.databinding.FragmentLoginByUsernameBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class LoginByUsernameFragment :
    BaseFragment<FragmentLoginByUsernameBinding, LoginState, LoginEvent, LoginRouter.Routes, LoginViewModel>()  {
