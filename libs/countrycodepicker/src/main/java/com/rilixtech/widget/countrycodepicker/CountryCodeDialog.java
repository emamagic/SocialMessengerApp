...
class CountryCodeDialog extends Dialog {
  ...
  CountryCodeDialog(CountryCodePicker countryCodePicker) {
    super(countryCodePicker.getContext(), R.style.AppTheme_FullScreenDialog);
  ...
  private void applyQuery(String query) {
    ...
    if (query.length() <= 0) {
      mEdtSearch.setBackground(getContext().getResources().getDrawable(R.drawable.bg_search_country_default));
    } else {
      mEdtSearch.setBackground(getContext().getResources().getDrawable(R.drawable.bg_search_country_select));
    }
