...
public class CountryCodePicker extends RelativeLayout {
  ...
  public interface OnCountrySelected {
    void onCountrySelect(@DrawableRes int flag);
  }
  ...
  private void applyCustomProperty(AttributeSet attrs) {
    ...
    try {
      ...
      mHideArrowDownSelector = a.getBoolean(R.styleable.CountryCodePicker_hide_arrowDown_selector, false);
      ...
      if (mHideArrowDownSelector) mImvArrow.setVisibility(View.GONE); else mImvArrow.setVisibility(View.VISIBLE);
  ...
  protected void setSelectedCountry(Country selectedCountry) {
    ...
    if (countrySelected != null) {
      countrySelected.onCountrySelect(CountryUtils.getFlagDrawableResId(selectedCountry));
    }
  ...
  public void setOnCountrySelected(OnCountrySelected countrySelected) {
